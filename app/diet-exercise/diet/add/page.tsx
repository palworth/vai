...
export default function AddDietEventPage() {
  ...
  const handleSuccess = () => {
    showToast('Diet Event Added', 'The diet event has been successfully added.', false)
    setTimeout(() => {
  ...
  return (
    <ToastProvider>
      <div className="min-h-screen bg-gray-100">
        <PageHeader title="Add Diet Event" />
        <main className="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
          <Card>
            <CardHeader>
              <CardTitle>Add New Diet Event</CardTitle>
              <CardDescription>Select a dog and enter the diet event details</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="mb-6">
