...
export default function DashboardsPage() {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-6">Pet Health Dashboards</h1>
      ...
      {selectedDogId && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              <CardTitle>Overall Health Dashboard</CardTitle>
            </CardHeader>
            <CardContent>
              <OverallDashboard key={`overall-${selectedDogId}`} dogId={selectedDogId} />
            </CardContent>
          </Card>
          <Card>
            <CardHeader>
              <CardTitle>Diet Dashboard</CardTitle>
            </CardHeader>
            <CardContent>
              <DietDashboard key={`diet-${selectedDogId}`} dogId={selectedDogId} />
            </CardContent>
          </Card>
        </div>
      )}
